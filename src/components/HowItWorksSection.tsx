  ...
  const steps = [
    {
      ...
      description:
        "Set up your parsing mailbox and define templates to extract key information from incoming emails.",
      details: [
    ...
    },
    {
      ...
      description:
        "Incoming emails are parsed and converted into structured support tickets with all relevant information.",
      details: [
    ...
    },
    {
      ...
      description:
        "Tickets are categorized and assigned to the right team members based on extracted information.",
      details: [
    ...
    },
    {
      ...
      description:
        "Track ticket resolution and analyze performance data to continuously improve your support process.",
      details: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600">
            A simple, four-step process to transform your customer support
            experience
          </p>
        </div>
