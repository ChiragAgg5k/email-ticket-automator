        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 lg:pr-8 mb-12 lg:mb-0 animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-helpdesk-dark mb-6 leading-tight">
              <span className="text-helpdesk-blue">Automate</span> Your Helpdesk with{" "}
              <span className="text-helpdesk-teal">Email Parsing</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              Transform incoming customer emails into structured support tickets instantly.
              ...
              <div className="pt-6">
                <div className="bg-gray-50 p-4 rounded-md">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <p className="text-sm text-gray-500">From: customer@example.com</p>
                      <p className="font-medium">Technical issue with your software</p>
                    </div>
                  </div>
                  <div className="h-24 bg-white rounded border border-gray-200 p-2 text-sm text-gray-600 mb-4">
                    Hi Support Team, I'm experiencing an error when trying to export reports. The system shows "Error 404" when I click the export button. Priority: High. Thanks, John
                  </div>
                  <div className="flex justify-center">
                    <svg className="w-6 h-6 text-helpdesk-teal animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="bg-gray-50 p-4 rounded-md">
                  <div className="bg-white rounded border border-gray-200 p-3 mb-3">
                    <div className="flex justify-between mb-2">
                      <span className="font-medium">New Support Ticket #12345</span>
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      <p><strong>Issue:</strong> Error 404 when exporting reports</p>
                    </div>
                  </div>
